    ...
    <div class = "create-update-form">
        <el-dialog :visible.sync = "dialogShow" width = "45%" :close-on-click-modal = "false" @close = "close" @open = "open">
            <el-tabs active-name = "first">
                <el-tab-pane :label="categoryId ? '修改分类' : '创建分类'" name = "first"></el-tab-pane>
            </el-tabs>
            <div class="form-container">
                <el-form :model="category" label-width="100px" ref="form">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" v-if="categoryId" @click.native="update" :loading="saving" size="small">保存</el-button>
