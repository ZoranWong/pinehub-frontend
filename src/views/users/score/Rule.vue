      ...
      <el-tabs active-name="first">
  		...
  		<div class="form-container">
  			<el-form :model="rule"  label-width="120px"  ref="rule">
                ...
                <el-radio label="ORDERS_COUNT" style = "display: inline-block;">每成功交易</el-radio>
  				    	<el-form-item label="" label-width="10px" prop="orders_count" style="display: inline-block;">
  							    <el-input v-model="rule['orders_count']" style="width:50%" size = "small" :disabled = "rule['type'] !== 'ORDERS_COUNT'">
                ...
                <el-radio label="ORDER_AMOUNT" style = "display: inline-block;">每购买金额</el-radio>
  				...
  				<el-form-item label="" prop="merchandise" label-width="140px" v-if="rule['type'] === 'ORDER_AMOUNT'"
