<template>
    <el-table  highlight-current-row :data="coupons">
        ...
        <el-table-column prop="activeTime" label="有效时间" min-width="100"></el-table-column>
        ...
        <el-table-column prop="usedNum" label="使用数" min-width="100"></el-table-column>
        <el-table-column prop="usedRate" label="使用率" min-width="100"></el-table-column>
