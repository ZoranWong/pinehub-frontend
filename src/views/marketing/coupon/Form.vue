<template>
  <el-form v-model = "ticket" label-width="120px" ref = "ticket">
    <div class = "ticket-info base-info">
      ...
      <el-form-item prop = "base_info.title" label = "优惠券名称：" :rules = "[{required: true, message: '请输入优惠券名称', trigger: 'blur'}]">
        <el-input v-model = "ticket['base_info']['title']" max = "16"></el-input>
      </el-form-item>
      <el-form-item prop = "base_info.sku.quantity" label = "发放总量：" :rules = "[{required: true, message: '请填写发放总量', trigger: 'blur'}]">
        <el-input v-model.number = "ticket['base_info']['sku']['quantity']" type = "number">
      ...
      <el-form-item prop = "type" label = "优惠形式：">
        <el-radio-group v-model = "ticket['type']">
          ...
          <el-form-item label-width="64px" v-if = "ticket['type'] === 'CASH'" label="面值：">
            <el-input v-model="ticket['reduce_cost']" type="number">
      ...
      <el-form-item prop = "least_cost" label = "使用限制">
        <el-radio-group v-model = "ticket['is_limited']">
          ...
          <el-radio :label="true" >满<el-input v-model = "ticket['least_cost']"></el-input>元可使用</el-radio>
        </el-radio-group>
      </el-form-item>
    ...
    <div class = "ticket-info base-rules">
      ...
      <el-form-item label="每人限领：">
        <el-input v-model.number = "ticket['base_info']['get_limit']" type = "number">
          <template slot = "append">张</template>
        </el-input>
      </el-form-item>
      ...
      <el-form-item label = "使用说明:" prop = "base_info.description">
        <el-input v-model = "ticket['base_info']['description']" type = "textarea"></el-input>
      </el-form-item>
      <el-form-item label = "客服电话：" prop = "base_info.service_phone">
        <el-input v-model = "ticket['base_info']['service_phone']" type = "number"></el-input>
      </el-form-item>
    </div>
  </el-form>
</template>
