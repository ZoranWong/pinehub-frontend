<template>
    <el-form :model="activity" label-width="120px" ref="activity">
        ...
        <el-form-item label="生效时间：" prop="begin_at" style="display: inline-block;" :rules="[{ required: true, message: '请选择开始时间', trigger: 'blur' }]">
            <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="activity['begin_at']" type="datetime" :picker-options="startOptions" :editable="false" placeholder="开始时间" style="">
            </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="" prop="end_at" label-width="10px" style="display: inline-block;" :rules="[{ required: true, message: '请选择结束时间', trigger: 'change' }]">
            <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="activity['end_at']" type="datetime" :picker-options="endOptions" :editable="false" placeholder="结束时间" style="">
            </el-date-picker>
        </el-form-item>
                ...
                <el-table-column prop="least_amount" label="优惠门槛" min-width="220">
                    <template slot-scope="scope">
                        <el-form-item :prop="'gifts[' + scope.$index + '][\'least_amount\']'" style="margin-left: 0 !important;"
                            ...
                            满 <el-input-number  size="mini" class="gift-input" :debounce="600" v-model.number="gifts[scope.$index]['least_amount']" :controls="false" type="number"></el-input-number>  元
                        </el-form-item>
                    </template>
                </el-table-column>
                            ...
                            <el-checkbox-group v-model="gifts[scope.$index]['gift_types']" >
                                <div class="cash-gift">
                                    <el-checkbox label="cost" >现金抵用礼包
                                        <el-form-item  class = "inline-block"  :prop = "'gifts[' + scope.$index + '][\'cost\']'" label-width = "5px" v-if = "isSelected(gifts[scope.$index], 'cost')" >
                                            <el-input v-model.number = "gifts[scope.$index]['cost']"  size = "mini" class = "gift-input" type = "number"></el-input> 元
                                        </el-form-item>
                                    </el-checkbox>
                                </div>
                                <div class="discount-gift">
                                    <el-checkbox label="discount">打折
                                        <el-form-item class = "inline-block" :prop = "'gifts[' + scope.$index + '][\'discount\']'" label-width = "5px" v-if = "isSelected(gifts[scope.$index], 'discount')">
                                ...
                                <div class = "score-gift">
                                    <el-checkbox label = "score"> 送积分
                                        <el-form-item class = "inline-block" :prop = "'gifts[' + scope.$index + '][\'score\']'" label-width = "5px" v-if = "isSelected(gifts[scope.$index], 'score')">
