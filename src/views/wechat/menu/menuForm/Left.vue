    ...
    export default {
        ...
        methods: {
            addSubMenu(index, subIdex) {
                let sub={ name: `子菜单${subIdex}` , type: 'view'};
                if(!this.menu.menus[index].sub_button) {
                    this.$set(this.menu.menus[index], 'sub_button', [sub]);
                }else{
            ...
            addMenu(index) {
                ...
                this.menu.editedMenu = {name: `菜单${index}`, type: 'view', sub_button: [], url: null, appid: null, pagepath: null};
