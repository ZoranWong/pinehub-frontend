        ...
        <template slot="searchInput">
            ...
            <el-form-item prop="province">
                <el-select size="small" v-model="provinceId">
                    <el-option label="请选择省" value="" @click="cityId = '';countyId = ''"></el-option>
                    <el-option v-for="(province, index) in provinces" :label="province.name" :value="province.id" :key="index"
                               @click="cityId = '';countyId = ''"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item prop="city">
                <el-select size="small" v-model="cityId">
                    <el-option label="请选择市" value="" @click="countyId = ''"></el-option>
                    <el-option v-for="(city, index) in cities" :label="city.name" :value="city.id" :key="index" @click="countyId = ''"></el-option>
                </el-select>
            </el-form-item>
