		...
		data(){
			return {
		        bar: {
				    ...
				    series: [{
				        data: [820, 932, 901, 934, 1290, 1330, 320, 220, 540, 780, 820, 1612, 130, 120, 1420, 920, 1100, 700, 630, 1120, 2036, 430, 720, 630, 920, 880, 1420, 1800, 530, 750],
				        type: 'line'
				    }]
				},
			}
